...
-- -----------------------------------------------------
-- Table `GISApp`.`OBSERVER_TARGET`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GISApp`.`OBSERVER_TARGET` (
...
-- -----------------------------------------------------
-- Table `GISApp`.`TIMER_SETTING`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GISApp`.`TIMER_SETTING` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `APPLICATION` VARCHAR(45) NOT NULL,
  `MODULE` VARCHAR(45) NOT NULL,
  `CLASS` MEDIUMTEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `GISApp`.`OBSERVER_SETTING`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GISApp`.`OBSERVER_SETTING` (
  `ID` INT NOT NULL AUTO_INCREMENT,
